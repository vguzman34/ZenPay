...
VALUES
    (uuid_generate_v4(), 'cliente@zenpay.com', '$2b$10$FUrg/sN.027JK8rIlaj5Ru0.M764cyowm5mJybMRg7MWLCAYOcIzK', 'Vanesa Gómez', '+573001234567', 'https://ui-avatars.com/api/?name=Vanesa+Gomez&background=6C63FF&color=fff', 'ROLE_ADMIN', true, true, NOW(), NOW(), NOW()),
    (uuid_generate_v4(), 'usuario@zenpay.com', '$2b$10$FUrg/sN.027JK8rIlaj5Ru0.M764cyowm5mJybMRg7MWLCAYOcIzK', 'Carlos López', '+573009876543', 'https://ui-avatars.com/api/?name=Carlos+Lopez&background=FF6B6B&color=fff', 'ROLE_USER', true, true, NOW(), NOW(), NOW());
